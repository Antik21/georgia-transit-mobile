...
object AutomationId {
    ...
    const val MapWalkingEstimate = "map.walking-estimate"
    const val MapWalkingEstimateLoading = "map.walking-estimate.loading"
    const val MapWalkingEstimateReady = "map.walking-estimate.ready"
    const val MapWalkingEstimateUnavailable = "map.walking-estimate.unavailable"
    const val MapWalkingEstimateAction = "map.walking-estimate.action"
    ...
    const val RoutesSearch = "routes.search"
    const val RoutesList = "routes.list"
    const val RoutesLoading = "routes.loading"
    const val RoutesEmpty = "routes.empty"
