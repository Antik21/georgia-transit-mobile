...
The wrapper pins Gradle 9.3.1 with checksum. Project versions are centralized in `gradle/libs.versions.toml`: AGP 9.1.1, Kotlin 2.4.10, Compose Multiplatform 1.12.0, Material 3 1.9.0, Java 17, compile SDK 37, min SDK 33, target SDK 36, Koin 4.2.2, Navigation 3 1.1.1, Orbit 11.0.0, Ktor 3.3.3, and SLF4J Simple 2.0.17. SLF4J Simple is the BFF's sole MIT-licensed, no-cost runtime logging provider.
