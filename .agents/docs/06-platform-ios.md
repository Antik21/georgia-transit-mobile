...
`iosApp` owns SwiftUI lifecycle, starts shared dependency injection once from `GeorgiaTransitApp`, and embeds the shared `ComposeUIViewController`. `iosMain` owns Darwin/UIKit adapter implementations. Product navigation and screens stay common.
