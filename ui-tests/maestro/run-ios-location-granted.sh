...
flow_path="$script_dir/flows/location-granted-smoke.yaml"
...
xcrun simctl privacy "$simulator_udid" reset all "$app_id"
xcrun simctl privacy "$simulator_udid" grant location "$app_id"
xcrun simctl location "$simulator_udid" set 41.7151,44.8271
